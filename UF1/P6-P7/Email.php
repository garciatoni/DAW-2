...
try {
    ...
    $mail->Body    = 'Dale al link si deseas recuperar la contraseña, de lo contrario no respondas al correo <a href="https://dawjavi.insjoaquimmir.cat/agarcia/M07/UF1/P6/GeneracionPassword.php?token='.$token.'">Recuperar Password</a>';//MIRAR
