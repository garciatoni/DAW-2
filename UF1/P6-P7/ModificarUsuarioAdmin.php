    ...
    <body>
        <form action="EliminarUsuario.php" method="post" id="myform" name="myform">       
            <div class="form-inline mt-5">
                <label for="Email" class="offset-sm-2 col-sm-3 text-alight-right">Correo del usuario a modificar</label>
                <input type="text" name="E-mail" class="form-control col-sm-2" placeholder="E-mail">
                <button class="bg-info text-white" type="submit">Modificar</button><span class="alert m-0 p-0"><?php echo $erroremail;?></span>
            </div>
            <a class = "offset-5 mt-2"href="Privada.php">Atras</a>
        <form>
    </body>
</html>
