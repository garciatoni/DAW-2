  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-light bg-dark mb-3 ">
        <div class="collapse navbar-collapse container-fluid d-flex" id="navbarSupportedContent">
          <a href="PaginaPrincipal.php" class="navbar-brand m-0 p-0 text-white" >Mercadillo.com</a>
          <div class="justify-content-end">
            <a clas="" href="Publica.php"><button class="btn-info">Conectarse</button></a>
            <a clas="" href="Registro.php"><button class="btn-info">Registrarse</button></a>
          </div>
        </div>
    </nav>
